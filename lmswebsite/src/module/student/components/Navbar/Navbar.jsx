...
function NavBar() {
  ...
  useEffect(() => {
    const apiCaller = async () => {
      ...
      const user = await getStudentByAuthId(authId);
      setUserId(user.student.user_id._id);
      console.log(user.student.user_id._id);
      const storedNotifications = await getUnreadNotifications(user.student.user_id._id);
