...
import {
  ...
  SubText,
  Subtitle,
} from "./StudentEnrollmentVideoView.style"; // Importing the styled components from style.js

const StudentEnrollmentVideoView = () => {
...
export default StudentEnrollmentVideoView;
