...
import { Link, useLocation, useNavigate } from "react-router-dom"; // Importing useLocation from react-router-dom
...
function NavBar() {
  ...
  useEffect(() => {
    const apiCaller = async () => {
      ...
      const storedNotifications = await getUnreadNotifications(user.user._id)
