...
import Dashboard from './module/admin/page/Dashboard/Dashboard';
      ...
      <Router>
        <Routes>
          ...
          <Route path="/admin" element={<DashboardLayout />}>
            ...
            <Route path='/admin/applicationFormReview' element={<ApplicationFormReview />} />
            <Route path='/admin/applicationFormReview/teacher/:teacherId' element={<TeacherApplicationFormReview />} />
            ...
            <Route path='/admin/customerQueries/:queryId' element={<CustomerQueryFormView />} />
          </Route>
        </Routes>
      </Router>
    </ThemeProvider>
